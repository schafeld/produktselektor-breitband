<template>
  <div class="recommendation-overlay">
    ...
    <h3 class="h2">Wie viele Geräte hast Du im Haushalt?</h3>
    <div class="flexbox-row">
      <div class="flexbox-cell flexbox-cell--w100">
        <div
      ...
      <div class="flexbox-cell flexbox-cell--w100 flexbox-cell--vDivider">
        <div
          class="flexbox-row counter-category"
